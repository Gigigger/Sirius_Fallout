...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "N14", CVar.ARCHIVE); // #Misfits Change - reverted back to N14
    ...
    /// </summary>
    public static readonly CVarDef<int>
        GameMaxCharacterSlots = CVarDef.Create("game.maxcharacterslots", 6, CVar.ARCHIVE | CVar.SERVERONLY);
    ...
    // #Misfits Tweak - Bumped default to 120 to match Misfits server population target
    ...
    public static readonly CVarDef<int> WhitelistReservedSlots =
        CVarDef.Create("game.whitelist_reserved_slots", 40, CVar.SERVERONLY | CVar.ARCHIVE);
