autodoc-verb-open = Open
autodoc-verb-close = Close
autodoc-verb-eject = Eject Patient
autodoc-opened = You open the autodoc.
autodoc-closed = You close the autodoc.
autodoc-not-open = The autodoc is closed!
...
autodoc-door-open-button = OPEN DOOR
autodoc-door-close-button = CLOSE DOOR
autodoc-eject-beaker = EJECT BEAKER
autodoc-eject-patient = EJECT PATIENT
autodoc-start-treatment = START TREATMENT
autodoc-treatment-progress = TREATMENT IN PROGRESS

autodoc-door-open = DOOR OPEN
autodoc-door-closed = DOOR CLOSED

autodoc-status-alive = VITAL SIGNS: STABLE
autodoc-status-critical = VITAL SIGNS: CRITICAL
autodoc-status-dead = VITAL SIGNS: NONE - DECEASED
autodoc-status-unknown = STATUS: UNKNOWN
autodoc-status-awaiting = AWAITING SUBJECT
autodoc-no-patient = NO PATIENT

autodoc-damage-blunt = BRUTE
autodoc-damage-slash = SLASH
autodoc-damage-piercing = PIERCING
autodoc-damage-heat = BURN
autodoc-damage-cold = FROSTBITE
autodoc-damage-shock = ELECTROCUTION
autodoc-damage-caustic = ACID
autodoc-damage-radiation = RADIATION
autodoc-damage-bloodloss = BLOOD LOSS
autodoc-damage-asphyxiation = ASPHYXIA
autodoc-damage-poison = POISON
autodoc-damage-toxins = TOXINS
autodoc-damage-genetic = GENETIC
autodoc-damage-cellular = CELLULAR
autodoc-damage-none = NO DAMAGE DETECTED
autodoc-damage-no-patient = NO PATIENT

autodoc-stimulants-none = NONE
