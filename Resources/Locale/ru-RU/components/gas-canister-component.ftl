...
comp-gas-canister-ui-holding-tank-status = Удержание статуса резервуара
comp-gas-canister-ui-holding-tank-label = Этикетка бака:
comp-gas-canister-ui-holding-tank-label-empty = Пустой
comp-gas-canister-ui-holding-tank-pressure = Давление в баке:
...
comp-gas-canister-ui-release-valve-close = Закрывать
