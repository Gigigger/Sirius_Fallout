...
gas-analyzer-component-player-cannot-reach-message = Вы не можете добраться туда.
gas-analyzer-shutoff = Газоанализатор отключается.

## UI

gas-analyzer-window-name = Газоанализатор
gas-analyzer-window-environment-tab-label = Среда
...
gas-analyzer-window-percentage-column-name = None
