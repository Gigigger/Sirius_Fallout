...
job-name-enclave-nco = Анклав унтер-офицер
job-description-enclave-nco = Поддерживать дисциплину, обучать личный состав, обеспечивать тактическую готовность на местах.
job-name-enclave-enlisted = Анклав в списке
job-description-enclave-enlisted = Станьте передовым солдатом Анклава, выполняйте приказы и выполняйте миссии.
...
job-name-enclave-scientist = Ученый Анклава
...
job-name-ncr-ranger-recruit = Рекрут рейнджера
job-description-ncr-ranger-recruit = Вы новичок в составе «Рейнджерс» на станции Бонневиль. Выполняйте приказы, изучайте основы и докажите, что у вас есть все необходимое, чтобы заработать значок.

job-name-synthetic-mr-handy = Мистер Хэнди
...
job-name-synthetic-mr-gutsy = г-н Гатси
...
job-description-follower-head = Вы возглавляете эту главу Последователей. Больные, любопытные и отчаявшиеся обращаются к вам за указаниями. Подавайте пример, защищайте своих людей и сохраняйте миссию.
job-name-follower-doctor = Последователи Доктор
...
job-name-follower-volunteer = Последователи-волонтеры
...
job-name-bos-west-scribe = Главный писец Братства
