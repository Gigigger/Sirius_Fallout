...
job-description-ncr-commander = Вы командуете подразделением НКР. Устанавливайте оперативные приоритеты, отдавайте приказы своим офицерам и подчиняйтесь только высшему командованию.

job-name-ncr-executive-officer = Исполнительный офицер НКР
job-description-ncr-executive-officer = Вы являетесь заместителем командира, руководите повседневными операциями подразделения и поддерживаете дисциплину среди сержантов и офицеров. Подавайте пример и поддерживайте связь с командованием и нижестоящими чинами.

job-name-ncr-platoon-leader = Полевой офицер НКР
job-description-ncr-platoon-leader = Вы командуете взводом в полевых условиях, руководите сержантами и выполняете приказы исполнительного офицера и командира.
