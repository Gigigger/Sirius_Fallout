...
autodoc-opened = Вы открыли автодок.
autodoc-closed = Вы закрыли автодок.
autodoc-not-open = Автодок закрыт!
...
autodoc-patient-ejected = ПАЦИЕНТ ИЗВЛЕЧЁН ИЗ АВТОДОКА
...
autodoc-door-open-button = ОТКРЫТЬ ДВЕРЬ
autodoc-door-close-button = ЗАКРЫТЬ ДВЕРЬ
autodoc-eject-beaker = ИЗВЛЕЧЬ СТАКАН
autodoc-eject-patient = ИЗВЛЕЧЬ ПАЦИЕНТА
autodoc-start-treatment = НАЧАТЬ ЛЕЧЕНИЕ
autodoc-treatment-progress = ПРОЦЕСС ЛЕЧЕНИЯ...

autodoc-door-open = ДВЕРЬ ОТКРЫТА
autodoc-door-closed = ДВЕРЬ ЗАКРЫТА
...
autodoc-damage-blunt = УШИБЫ
autodoc-damage-slash = РЕЖУЩИЙ
autodoc-damage-piercing = КОЛЮЩИЙ
autodoc-damage-heat = ОЖОГ
autodoc-damage-cold = ОБМОРОЖЕНИЕ
autodoc-damage-shock = ЭЛЕКТРОТРАВМА
autodoc-damage-caustic = КИСЛОТА
autodoc-damage-radiation = РАДИАЦИЯ
autodoc-damage-bloodloss = КРОВОПОТЕРЯ
autodoc-damage-asphyxiation = АСФИКСИЯ
autodoc-damage-poison = ЯД
autodoc-damage-toxins = ТОКСИНЫ
autodoc-damage-genetic = ГЕНЕТИКА
autodoc-damage-cellular = КЛЕТКИ
autodoc-damage-none = ПОВРЕЖДЕНИЙ НЕ ОБНАРУЖЕНО
autodoc-damage-no-patient = НЕТ ПАЦИЕНТА
