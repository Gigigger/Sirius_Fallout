...
comp-secret-stash-action-hide-success = Вы спрятали { THE($item) } в { $this }
comp-secret-stash-action-hide-container-not-empty = Здесь уже что-то есть?!
comp-secret-stash-action-hide-item-too-big = { THE($item) } слишком велик, чтобы поместиться в {$stash}!
