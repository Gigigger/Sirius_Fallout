...
book-text-demonomicon3 = Крутые имена демонов, которые я нашел
      - by Ms. Mossrock
...
book-text-chemistry-insane = ИГОРЬ ХИМИЯ ПУТЕВОДИТЕЛЬ ПО ХИМИИ
...
book-text-botanics = ** Применение ботанических образцов, обнаруженных на территориях Нанотрасена **
...
book-text-gnome = Слава нашему королю гномов
...
book-text-fishing = Когда я вырасту, я хочу стать одним из жнецов космического моря!
