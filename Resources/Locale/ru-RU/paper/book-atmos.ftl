book-text-atmos-distro = Распределительная сеть, или для краткости «дистрибьютор», является спасательным кругом станции. Он отвечает за транспортировку воздуха из атмосферы по всей станции.
...
book-text-atmos-waste = Сеть отходов является основной системой, отвечающей за очистку воздуха на станции от загрязнений.
