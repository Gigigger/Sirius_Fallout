...
guidebook-reagent-name = [bold][color=__PH0__]{CAPITALIZE($name)}[/color][/bold]
...
guidebook-reagent-plant-metabolisms-rate = [bold]Метаболизм растений[/bold] [color=gray](1 единица каждые 3 секунды в качестве основы)[/color]
guidebook-reagent-physical-description = [italic]Похоже на {$description}.[/italic]
